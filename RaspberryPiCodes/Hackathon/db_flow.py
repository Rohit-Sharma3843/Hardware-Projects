...
# =======================
tank_width = 10       # cm
tank_height = 100     # cm (REAL TANK HEIGHT)
initial_level_cm = tank_height  # full tank reference
...
def show_water_screen():
    ...
    log(f"LCD WATER -> Level:{current_level_cm:.2f}cm Used:{water_used_l:.2f}L")
